 ...
 * Strips bidi overrides (RLO/RLE/FSI/etc.) that reverse live chat, plus
 * unpaired UTF-16 surrogates that Postgres json/jsonb rejects. Keeps real emoji.
 */
...
function sanitizePublicText(value, max = 80) {
