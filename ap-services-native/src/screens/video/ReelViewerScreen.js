    ...
    return (
      <View style={[styles.page, { height: H, width: W }]}>
        ...
        <View style={[styles.overlay, { paddingBottom: 28 + insets.bottom }]} pointerEvents="box-none">
          <Pressable onPress={() => navigation.navigate('CreatorProfile', { userId: item.authorId, name: item.authorName })}>
              ...
              {comments.map((c, i) => {
                ...
                return (
                  <Pressable
                    ...
                    onPress={() => id && navigation.navigate('CreatorProfile', { userId: id, name })}
                  >
            ...
            <ScrollView style={{ maxHeight: 320 }}>
              {likers.map((u, i) => (
                <Pressable
                  ...
                  onPress={() => {
                    setLikersPost(null);
                    if (u.userId) navigation.navigate('CreatorProfile', { userId: u.userId, name: u.displayName });
                  }}
                >
